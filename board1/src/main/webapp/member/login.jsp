...
<h4 class="border-bottom mx-5 pt-3">로그인 </h4>
<div class='container pt-3'>
 
<form class="form" method='post' action='login.do' target="_top" name="form1">
	...
	<div class="form-group row">
		<label for="pwd" class="col-sm-2 col-md-2">비밀번호</label>
	 	...
	 	<input class="form-control form-control-sm col-sm-1 col-md-1 
