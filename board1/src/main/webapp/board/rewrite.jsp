...
<h4 class="border-bottom mx-5 pt-3"> 글 수정 </h4>

<div class='container pt-3'>

<form class="form" method='post' action='updating.do?seq=${bdto.seq}' target="_top" name="form1">
	...
	<div class="form-group row">
		...
		<input class="form-control form-control-sm col-sm-6 col-md-6" 
				type='text' name='header' value="${bdto.header}" required >
	</div>
	...
	<div class="form-group row">
		<label for="content" class="col-sm-2 col-md-2 text-center">내용</label>
	 	<textarea class="form-control form-control-sm col-sm-6 col-md-6" 
	 			rows="10" name='content' required>"${bdto.content}"</textarea>	
	</div>
